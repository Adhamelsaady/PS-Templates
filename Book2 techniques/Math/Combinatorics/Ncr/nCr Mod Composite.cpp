 ...
 *
 * What this file does:
 * Computes C(n,r) modulo a composite modulus, where factorial inverse is not directly valid. It handles prime powers and combines them with CRT.
 *
 * Typical problem to recognize:
 * For a composite modulus, an element may have no modular inverse. Factor the modulus into prime powers first.
 *
 * Complexity / constraints:
 * Advanced template; check constraints in the source before using.
 *
 * Main variables:
 * n,r = binomial query; mod = composite modulus; p/e = prime factor and exponent.
 *
...
// Function: mul_mod(int64 a, int64 b, int64 mod).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
int64 mul_mod(int64 a, int64 b, int64 mod) {
    return (int64) ((i128) a * b % mod);
}

// Function: pow_mod(int64 a, int64 e, int64 mod).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: extgcd(int64 a, int64 b, int64 &x, int64 &y).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: inv_mod(int64 a, int64 m).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: count_p_in_fact(int64 n, int64 p).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: block_prod_without_p(int64 p, int64 pe).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: fact_without_p_mod_pe(int64 n, int64 p, int64 pe, int64 block_prod).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: nCr_mod_prime_power(int64 n, int64 r, int64 p, int64 q).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: nCr_mod(int64 n, int64 r, int64 M).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
