/*
 * Permutation Rank and Unrank
 *
 * What this file does:
 * Converts a permutation to its lexicographic rank and/or converts a rank back to a permutation.
 *
 * Typical problem to recognize:
 * Factoradic representation stores a permutation as digits with bases 1,2,...,n.
 *
 * Complexity / constraints:
 * Useful for kth permutation and permutation indexing.
 *
 * Main variables:
 * len = permutation length; nth/rank = requested 1-based position; fact = factorials; set = unused values.
 *
...
// Function: permutation_in_order(vector<int>&v).
