 ...
 *
 * What this file does:
 * Implements Dirichlet convolution of arithmetic functions.
 *
 * Typical problem to recognize:
 * (f*g)(n)=sum_{d|n} f(d)g(n/d).
 *
 * Complexity / constraints:
 * It is the natural multiplication operation for many divisor-sum identities and Möbius inversion.
 *
 * Main variables:
 * f,g = arithmetic functions; h = convolution result; d = divisor.
 *
