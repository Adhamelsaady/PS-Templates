 ...
 *
 * What this file does:
 * Computes p(n), the number of ways to write n as a sum of positive integers where order does not matter.
 *
 * Typical problem to recognize:
 * An integer partition differs from a composition because 2+1 and 1+2 are the same partition.
 *
 * Complexity / constraints:
 * Generating functions and pentagonal-number identities are common tools.
 *
 * Main variables:
 * n = target sum; dp/g = partition counts.
 *
