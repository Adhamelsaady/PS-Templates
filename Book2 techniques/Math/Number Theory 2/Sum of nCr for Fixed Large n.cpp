/*
 * Sum of nCr for Fixed Large n
 *
 * What this file does:
 * Sums binomial coefficients over a fixed n or over array values.
 *
 * Typical problem to recognize:
 * C(n,k) counts ways to choose k elements from n.
 *
 * Complexity / constraints:
 * These sums often represent choosing k objects independently from several groups.
 *
 * Main variables:
 * n = upper binomial index; k = selected size; a[i] = input value; ans[k] = accumulated coefficient sum.
 *
...
class Mod {
private:
  // Function: mul_inv(word_t n, int e=6, word_t x=1).
...
// Function: convolve(mod_t* A, int s1, mod_t* B, int s2, bool cyclic=false).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
template <typename mod_t>
// Function: rev_permute(mod_t* A, int n).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
template <typename mod_t>
// Function: ntt_dit4(mod_t* A, int n, int sign, mod_t* roots).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
public:
  ...
  // Function: sub_mul_mod(R64 a, R b, R c).
  // Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
public:
  ...
  // Function: rev_add(const poly& rhs).
  // Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
private:
...
#ifdef NTT64
  // Function: mul_crt(int beg, int end).
  // Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
  ...
  // Function: mul2(const poly& f, const poly& g, bool cyclic=false).
  // Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
public:
  // Function: amul(const R* f, int s1, const R* g, int s2, R* res).
  // Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
  ...
  // Function: mul_basecase(const poly& g).
  // Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
  ...
  // 1.0 * M(n)
  // Function: middle_product(const poly& g).
  // Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: pow_mod(int b, int e, int mod).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: binomial_sum_mod_p(int N, int K, int mod).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
