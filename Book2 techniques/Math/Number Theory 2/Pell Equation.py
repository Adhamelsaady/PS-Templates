...
#
# What this file does:
# Solves x^2-Dy^2=1 using continued fractions.
#
# Typical problem to recognize:
# Pell equations are quadratic Diophantine equations with infinitely many solutions for nonsquare D.
#
# Complexity / constraints:
# Continued fractions of sqrt(D) reveal the fundamental solution.
#
# Main variables:
# D = nonsquare positive integer; x,y = integer solution.
#
