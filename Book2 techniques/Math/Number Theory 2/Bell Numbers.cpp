 ...
 *
 * What this file does:
 * Computes Bell numbers, the number of set partitions of n labeled elements.
 *
 * Typical problem to recognize:
 * A set partition splits elements into nonempty unlabeled groups.
 *
 * Complexity / constraints:
 * Bell numbers connect to Stirling numbers: B_n=sum_k S(n,k).
 *
 * Main variables:
 * n = number of elements; B[n] = Bell number.
 *
