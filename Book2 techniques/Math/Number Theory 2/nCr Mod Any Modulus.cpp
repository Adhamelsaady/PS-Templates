 ...
 *
 * What this file does:
 * Computes binomial coefficients modulo an arbitrary modulus, including composite moduli, by separating prime-power factors and combining the results.
 *
 * Typical problem to recognize:
 * For composite moduli, ordinary factorial inverses may not exist. Prime-power decomposition plus CRT avoids illegal modular division.
 *
 * Complexity / constraints:
 * Depends on the factorization of the modulus and the size of the precomputation.
 *
 * Main variables:
 * n,r = binomial arguments; mod = arbitrary modulus; p/e = prime-power components; fact = factorial information with p factors removed.
 *
...
// mod = multiple of p
// O(mod) * log(n)
// Function: factmod(ll n, int p, const int mod).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: multiplicity(ll n, int p).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// C(n, r) modulo p^k
// O(p^k log n)
// Function: ncr(ll n, ll r, int p, int k).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
