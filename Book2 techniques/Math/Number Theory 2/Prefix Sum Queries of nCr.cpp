 ...
 *
 * What this file does:
 * Answers prefix/range-style queries involving sums of binomial coefficients C(n,k) under a fixed modulus, using precomputation and modular arithmetic.
 *
 * Typical problem to recognize:
 * A prefix sum stores cumulative values so a range sum can be obtained by subtracting two prefixes.
 *
 * Complexity / constraints:
 * Check the query constraints and precomputation size in the source.
 *
 * Main variables:
 * n = binomial top; k = selected size; pref/table arrays = precomputed binomial sums; mod = prime modulus.
 *
