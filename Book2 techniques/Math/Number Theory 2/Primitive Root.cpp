 ...
 *
 * What this file does:
 * Finds a generator of the multiplicative group modulo a prime.
 *
 * Typical problem to recognize:
 * A primitive root g produces every nonzero residue as g^k modulo p.
 *
 * Complexity / constraints:
 * Useful for discrete log, discrete roots, and NTT setup.
 *
 * Main variables:
 * p = prime modulus; g = candidate primitive root; phi = p-1.
 *
