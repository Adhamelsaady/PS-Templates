...
// Function: fft(vector<base> &a, int n = -1).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: multiply(vector<int> &a, vector<int> &b, int eq = 0).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
int f[N], ifac[N];
// ans_k = sum_(C(a_i, k))
// Function: yo(int n, vector<int> a).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
