/*
 * Arithmetic Progression Power Sums
 *
 * What this file does:
...
// Function: Lagrange(vector<mint> &x, vector<mint> &y).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: power_sum(long long n, int k).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: solve(long long k1, long long k2, long long a, long long b, long long c, long long n).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
