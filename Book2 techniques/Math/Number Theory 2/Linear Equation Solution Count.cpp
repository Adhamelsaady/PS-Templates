 ...
 *
 * What this file does:
 * Counts solutions of a basic linear equation after transforming it into a combinatorial counting problem.
 *
 * Typical problem to recognize:
 * Many linear nonnegative-integer equations reduce to stars and bars: the number of ways to distribute n identical items into k nonempty/empty bins.
 *
 * Complexity / constraints:
 * Usually O(N) or O(N log N) after precomputation, depending on the exact helper used.
 *
 * Main variables:
 * n/k = problem parameters; dp/combination values = precomputed counts; mod = answer modulus.
 *
...
// Function: yo(int n, int s, int l, int r).
