/*
 * Polynomial and Finite Field Toolkit
 *
 * What this file does:
 * Provides modular polynomial/finite-field helpers built around a prime modulus and a modint type.
 *
 * Typical problem to recognize:
 * A finite field is a set with well-defined addition, subtraction, multiplication, and division by nonzero elements. For prime MOD, integers modulo MOD form a field.
 *
 * Complexity / constraints:
 * Most arithmetic operations are O(1); exponentiation is O(log k).
 *
 * Main variables:
 * MOD/mod = field modulus; value = normalized field element; x,y = temporary field elements; k = exponent.
 *
