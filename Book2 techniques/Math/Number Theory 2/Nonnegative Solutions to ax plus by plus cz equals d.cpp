/*
 * Nonnegative Solutions to ax plus by plus cz equals d
 *
 * What this file does:
...
// Function: floor_sum(T a, T d, T m, T n).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// O(log(max(a, b, c)));
// Function: count(T a, T b, T c, T n).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: brute(T a, T b, T c, T n).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
