...
struct Mint {
    ...
    // Function: reduce(const __uint128_t &x).
    // Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: suspect(const uint64_t &a, const uint64_t &s, uint64_t d, const uint64_t &n).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: is_prime(const uint64_t &n).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
...
// Function: rho_pollard(const uint64_t &n).
// Purpose: see the file header for the problem this helper solves; parameter names above are the contract.
