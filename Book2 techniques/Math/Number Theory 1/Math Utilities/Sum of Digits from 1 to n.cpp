 ...
 *
 * What this file does:
 * Computes the total of decimal digits for all integers from 1 to n.
 *
 * Typical problem to recognize:
 * Digit-position decomposition counts full cycles of 0..9 instead of visiting every number.
 *
 * Complexity / constraints:
 * Useful when n can be very large.
 *
 * Main variables:
 * n = upper bound; pos = decimal position; higher/current/lower = digit blocks; ans = digit sum.
 *
