/**
 * Solvers for two linear equations:
 *   a1*x + b1*y = c1
 *   a2*x + b2*y = c2
 *
 * The file contains variants for floating-point and integer arithmetic. It is
 * currently a snippet collection rather than a clean standalone translation
 * unit: two integer overloads have the exact same signature and must be renamed
 * or removed before compiling.
 */
#include<bits/stdc++.h>
using namespace std;
...
// Floating-point solver using Cramer rule; return convention uses +/-inf sentinels.
...
// Integer-coefficient solver using __int128 for determinant arithmetic.
