/**
 * Fast Walsh-Hadamard Transform using __int128 without modular reduction.
 *
 * f=0 -> AND convolution
 * f=1 -> OR convolution
 * f=2 -> XOR convolution
 *
 * This version is useful when exact integer arithmetic is wanted and the final
 * values fit inside __int128. The array size must be a power of two.
 */
#include<bits/stdc++.h>
...
// Forward/inverse Walsh-Hadamard transform for AND, OR, or XOR convolution.
...
// Convolution under the bitwise operation selected by f: 0=&, 1=|, 2=^.
